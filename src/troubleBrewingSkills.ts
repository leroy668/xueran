...
const skills: TroubleBrewingSkill[] = [
  ...
  { roleId: "virgin", phase: "白天", interaction: "记录首次提名者及能力是否触发", hostHint: "首次被镇民提名时，提名者立即被处决并结束白天；间谍可登记为镇民并触发。", trackerOptions: ["能力未触发", "被非镇民首次提名", "已触发并处决提名者"] },
  {
    ...
    playerChoice: { kind: "single", title: "杀手射击", help: "公开选择一名玩家作为本局唯一的射击目标", submitLabel: "提交目标", summaryPrefix: "杀手射击", phase: "day", allowFirstNight: false, excludeSelf: false, aliveOnly: false, oneUse: true },
  ...
  { roleId: "saint", phase: "被动", interaction: "记录圣徒是否被处决以及游戏结束状态", hostHint: "圣徒被处决时其阵营立即落败；间谍可登记为圣徒，但中毒或醉酒角色没有有效能力。", trackerOptions: ["能力正常", "处决风险已提醒", "已被处决 · 邪恶胜利"] },
  {
  ...
  { roleId: "scarlet-woman", phase: "被动", interaction: "记录恶魔死亡时是否满足继承条件", hostHint: "恶魔死亡且仍有至少五名玩家存活时，红唇女郎成为该恶魔。", trackerOptions: ["等待触发", "条件不足 · 未继承", "已继承恶魔"] },
  ...
  { roleId: "spy", phase: "夜晚", interaction: "上帝一键向间谍发送当前完整魔典快照及本晚行动信息", hostHint: "展示后仍可在其他能力中把间谍视为善良、镇民或外来者。" },
  {
    ...
    playerChoice: { kind: "single", title: "选择攻击目标", help: "选择自己时会继续要求选择一名玩家继承小恶魔", submitLabel: "提交攻击", summaryPrefix: "小恶魔攻击", phase: "night", allowFirstNight: false, excludeSelf: false, aliveOnly: false },
  },
  ...
  { roleId: "pukka", phase: "夜晚", interaction: "玩家选择新的中毒目标，上帝同时结算上一名中毒玩家死亡并恢复健康", hostHint: "首夜可以选择；座位卡应持续记录每晚的新旧目标。", playerChoice: { kind: "single", title: "普卡下毒", help: "选择一名玩家中毒；上一名中毒者死亡并恢复", submitLabel: "提交目标", summaryPrefix: "普卡下毒", phase: "night", allowFirstNight: true, excludeSelf: false, aliveOnly: false } },
  ...
  { roleId: "nodashii", phase: "夜晚", interaction: "玩家选择击杀目标，上帝同时确认恶魔两侧最近镇民的中毒状态", hostHint: "首夜只处理邻近镇民中毒，不进行击杀；两侧最近镇民均中毒，间谍可按登记规则改变邻接判定。", playerChoice: { kind: "single", title: "诺-达鲷攻击", help: "首夜后选择一名玩家死亡", submitLabel: "提交攻击", summaryPrefix: "诺-达鲷攻击", phase: "night", allowFirstNight: false, excludeSelf: false, aliveOnly: false } },
];
